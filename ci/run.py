...
def make_build_env():
    ...
    if on_github_actions():
        _env_add('PYTHONPATH', join(os.environ.get('RUNNER_TOOL_CACHE'), 'Python/3.13.3/x64/lib/python3.13/site-packages'))
    _env_add('PYTHONPATH', join(PREFIX, 'lib/python3.13/site-packages'))
