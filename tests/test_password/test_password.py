...
@pytest.mark.parametrize('rpc, enc_version',
                         [('create_repo', 2), ('create_repo', 3), ('create_repo', 4), ('create_repo', 5),
                          ('create_enc_repo', 2), ('create_enc_repo', 3), ('create_enc_repo', 4), ('create_enc_repo', 5)])
def test_encrypted_repo(rpc, enc_version):
    ...
    if rpc == 'create_repo':
        ...
        if enc_version == 2:
            ...
            repo_id = 'd17bf8ca-3019-40ee-8fdb-0258c89fb765'
    ...
    if enc_version == 3 or enc_version == 4 or enc_version == 5:
